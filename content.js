...
function detectXTheme() {
  ...
  if (match) {
    ...
    const isLight = brightness > 600;
    document.body.setAttribute('data-emilios-theme', isLight ? 'light' : 'dark');
    document.body.classList.toggle('rcrd-theme-light', isLight);
    document.body.classList.toggle('rcrd-theme-dark', !isLight);
  }
}
